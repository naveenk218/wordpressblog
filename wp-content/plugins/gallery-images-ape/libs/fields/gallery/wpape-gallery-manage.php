...
function wpape_gallery_manage_field( $field, $meta ) {
	...
	echo '	<button class="btn btn-success btn-lg "><span class="glyphicon glyphicon glyphicon-th" aria-hidden="true"></span> ' . __( 'Gallery Resources' ,'gallery-images-ape' ) . ' </button>';
	echo '</div>';
	echo '<p class="cmb2-metabox-description">'.__('Open gallery resources by click on Images button. Upload and configure gallery images here.','gallery-images-ape') . '</p>';
}
