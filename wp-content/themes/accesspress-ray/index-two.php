			...
			$query1 = new WP_Query( 'p='.$accesspress_ray_call_to_action_post_id );
				while ($query1->have_posts()) : $query1->the_post(); ?>
					...
					<?php if($accesspress_ray_settings['call_to_action_post_content'] == 0 || empty($accesspress_ray_settings['call_to_action_post_content'])){ ?>
						<p class="welcome-content"><?php echo esc_html(accesspress_ray_excerpt( get_the_content() , $accesspress_ray_call_to_action_post_char )); ?></p>
				...
				<h1 class="roboto-light main-title"><a href="#"><?php esc_html_e('Welcome to AccessPress Ray','accesspress-ray') ?></a></h1>
				<div  class="welcome-detail">
				<p><?php esc_html_e('Free Responsive, Multipurpose Business and Corporate Theme perfect for any business.','accesspress-ray') ?></p>
				<a class="read-more bttn" href="#"><?php esc_html_e('Read More','accesspress-ray') ?></a>
				</div>
...
<section id="mid-section" class="featured-section clearfix">
	<div class="ak-container">
		...
		if(!empty($featured_post1) || !empty($featured_post2) || !empty($featured_post3) || !empty($featured_post4)){
					...
					?>
						<div class="featured-post-wrapper">
							...
							<div class="featured-content">
								...
								<p><?php echo esc_html(accesspress_ray_excerpt( get_the_content() , 160 )); ?></p>
			...
			<div id="featured-post-<?php echo esc_attr($featured_post); ?>" class="featured-post">

				<div class="featured-post-wrapper">
                    <figure class="featured-image"><img src="<?php echo esc_url(get_template_directory_uri().'/images/demo/featuredimage-'.$featured_post.'.jpg'); ?>"></figure>
                    <div class="featured-more"><div><span>+</span></div><a href="#"><?php esc_html_e('Read More','accesspress-ray'); ?></a></div>
                </div>

				<div class="featured-content">
					<h2 class="featured-title"><a href="#"><?php echo esc_html__('Featured Post ','accesspress-ray').esc_html($featured_post); ?></a></h2>
					<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi cursus, purus id ultrices tristique, velit ante accumsan metus, non porttitor tortor elit pellentesque felis...','accesspress-ray'); ?></p>
					<a href="#" class="view-more"><?php esc_html_e('Read More','accesspress-ray'); ?></a>
				</div>
			</div>
			<?php }
			} ?>
...
<section id="bottom2-section" class="clients-say-section clearfix">
	<div class="ak-container">
		<?php if(!empty($testimonial_category)) {	?>
			 		<h3 class="roboto-light main-title"><?php echo esc_html(get_cat_name($testimonial_category)); ?></h3>
						<?php
					        	...
					        	<div class="testimonial-slide">
						        	<div class="testimonial-list clearfix">
						        		...
						        		<div class="testimonial-excerpt">
						        			<?php echo esc_html(accesspress_ray_excerpt( get_the_content() , 140 )); ?>
						        		</div>
						        	</div>
								</div>
			                <?php endwhile; ?>
						...
						?>
						<h3 class="roboto-light main-title"><?php esc_html_e('What our Clients Say', 'accesspress-ray') ?></h3>
						<div class="testimonial-wrap">
							<div class="testimonial-slider">
								<div class="testimonial-slide">
						        	<div class="testimonial-list clearfix">
						        		<div class="testimonial-thumbnail">
						        		<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/demo/Yanetxys-Torreblanca.jpg">
						        		</div>
						        		<div class="testimoinal-client-name"><?php esc_html_e('Yanetxys Torreblanca', 'accesspress-ray') ?></div>
						        		<div class="testimonial-excerpt"><?php esc_html_e('Thanks for delivering top quality services to your clients. It just takes a minute to get an answer from you when in difficulties.', 'accesspress-ray') ?></div>
						        	</div>
								...
								<div class="testimonial-slide">
						        	<div class="testimonial-list clearfix">
						        		<div class="testimonial-thumbnail">
						        		<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/demo/David-Soriano.jpg">
						        		</div>
						        		<div class="testimoinal-client-name"><?php esc_html_e('David Soriano', 'accesspress-ray') ?></div>
						        		<div class="testimonial-excerpt"><?php esc_html_e('Thank you very much the support team AccessPress Ray for service, are really wonderful in their care and in the resolution of the problem.', 'accesspress-ray') ?></div>
						        	</div>									
								</div>
							</div>
						</div>
...
<section id="top-section" class="events-section clearfix">
	<div id="latest-events" class="ak-container clearfix">
	        ...
	        <h1 class="roboto-light main-title"><a href="<?php echo esc_url(get_category_link($accesspress_ray_blog_cat)); ?>"><?php echo esc_html(get_cat_name($accesspress_ray_blog_cat)); ?></a></h1>
	        ...
	        <?php while ($loop->have_posts()) : $loop->the_post(); ?>
	        	...
	        	<div class="event-list clearfix">
	        		...
	        		<figure class="event-thumbnail clearfix">
						...
						<?php }else{
						?>
						<img src="<?php echo esc_url(get_template_directory_uri()) ?>/images/blog-fallback.jpg">
						<?php	
						}
						?>
						</a>
					...
					<?php
		        		...
		        		<div class="event-excerpt">
		        			<?php echo esc_html(accesspress_ray_excerpt( get_the_content() , 210 )); ?>
		        		</div>
	        ...
	        <a href="<?php echo esc_url(get_category_link($accesspress_ray_blog_cat)); ?>" class="view-all clearfix"><?php echo esc_html( $blogmore_text );?></a>
			<?php }else{ ?>
	        ...
	        <div class="event-slider">
		        ...
		        <div class="event-list clearfix">
						<figure class="event-thumbnail  ">
							<a href="#"><img src="<?php echo esc_url(get_template_directory_uri().'/images/demo/blog'.$event_count.'.jpg'); ?>" alt="<?php echo 'event'.esc_attr($event_count); ?>">
							</a>
						</figure>	
						...
						<div class="event-detail clearfix">
			        		...
			        		<h4 class="event-title">
			        			<a href="#"><?php echo esc_html__('Blog Post ','accesspress-ray'). esc_html($event_count); ?></a>
			        		</h4>

			        		<div class="event-excerpt">
			        			<?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi cursus, purus id ultrices tristique, velit ante accumsan metus, non porttitor tortor elit pellentesque felis...','accesspress-ray') ?>
			        		</div>

			        		<a class="read-more-btn" href="#"><?php esc_html_e('Read More','accesspress-ray') ?> <span class="read-icon-wrap"><i class="fa fa-angle-right"></i></span></a>
		        		</div>
		        </div>		        
		        <?php } ?>
		        </div>
...
<section id="google-map" class="clearfix">
		...
		<h3><?php esc_html_e('Contact Us', 'accesspress-ray'); ?></h3>
		<?php echo wp_kses_post(wpautop($accesspress_ray_settings['contact_address']));
